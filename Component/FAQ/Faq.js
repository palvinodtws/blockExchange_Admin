...
import CircularProgress from '@material-ui/core/CircularProgress';const { RangePicker } = DatePicker;
      ...
      <div className="new-dashboard">
        ...
        >
              ...
              <div className="left-dashboard mt-0 " id="lr-id">
                ...
                <table className="table funds-table mt-3" id="funds-color">
                  <thead>
                   ...
                   <th id="fuds" className="right-textset" scope="col"> </th> 
          ...
          {/* <td className="total-account"></td> */}
                              ...
                              <td
                                className="total-account  td-width right-textset" >
