          ...
          <ul className="sidebar-nav" id="sidebar-nav">
            ...
            <li className="nav-item">
              <a className="nav-link" href="/dashboard">
                {/* <img src="/others/dashboard.png"/> */}
                <i className="bi bi-columns-gap" id="i-class"></i>
                <span className="spanic">TOTAL USERS</span>
              </a>
            </li>

            <li className="nav-item">
              <a className="nav-link" href="/addUser/addUser">
                {/* <img src="/others/dashboard.png"/> */}
                <i className="bi bi-columns-gap" id="i-class"></i>
                <span className="spanic">ADD USER</span>
              </a>
            </li>
            <li className="nav-item">
              {/* <a
            ...
            <li className="nav-item">
              {/* <a
                ...
                href="#"
              >
                <i className="bi bi-badge-ad" id="i-class"></i>
